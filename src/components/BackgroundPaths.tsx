    ...
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
      ...
      <div className="container relative z-10 mx-auto px-4 text-center md:px-6">
        ...
        >
          ...
          <p className="text-xl md:text-3xl text-gray-600 dark:text-gray-300 mt-4 mb-8 font-light">
            Skip the queue, pre-order your favorite campus food
          </p>
          <div className="mt-8">
            <a 
              href="#menu"
              className="inline-block bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-3 rounded-full text-lg font-semibold hover:from-purple-700 hover:to-blue-700 transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Explore Our Cafes
            </a>
          </div>
